...
loader.load('./human_brain.glb', (gltf) => {
    ...
    if (isMobile) {
        brain.scale.set(0.48, 0.48, 0.48); // Tamanho arredondado e menor para celular
    } else {
        brain.scale.set(0.8, 0.8, 0.8);    // Tamanho padrão desktop
    }
...
window.addEventListener('resize', () => {
    ...
    // Garante a escala correta se mudar o tamanho da janela em tempo real
    if (brain) {
        if (isMobile) {
